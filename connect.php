<?php
// Database connection
$conn =  mysqli_connect('localhost', 'root', ' ', 'bookingtableabc12');
...
$stmt = $conn->prepare("INSERT INTO bookingtableabc12 (name, phone, person_outline, date, time_outline, message,email_address) VALUES (?, ?, ?, ?, ?, ?)");

if ($stmt) {
    $stmt->bind_param("siisss", $name, $phone, $person_outline, $date, $time_outline, $message, $email_address);
